...
hist=model.fit([encoder_input_data , decoder_input_data], decoder_output_data, batch_size=50, epochs=300 )

#model.save( 'trained_model.h5',hist)

 

#models=load_model("trained_model.h5")
...
def make_inference_models():
    ...
    # model.save("enc_model.h5",encoder_model)

    # model.save("dec_model.h5",decoder_model)
...
#     states_values = enc_model.predict( str_to_tokens( tokenize(input( 'Enter question : ' ) ) ) )
...
#                 ls=decoded_translation.split()

#                 ls=ls[:-1]

#                 decoded_translation=' '.join(ls)
